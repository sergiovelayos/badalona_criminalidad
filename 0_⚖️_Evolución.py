...
<br>Los datos reportados por el ministerio son acumulados trimestralmente evitando que pueda analizarse la evolución trimestral. 
<br>Para mejorar esta circunstancia, he tratado los datos desagregando por trimestre. 
<br>Además, he cruzado con el censo de cada ubicación y año para calcular la tasa por cada 1,000 habitantes con lo que es posible comparar ubicaciones con disintos censos.
<br><strong>Fuente de los datos:</strong>
...
<br><em> - Últimos datos disponibles: Tercer Trimestre 2025(actualizado el 2 de diciembre de 2025).</em>
<br>
